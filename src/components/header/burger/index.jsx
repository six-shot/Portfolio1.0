    ...
    return (
      <div>
        <div
          ...
          className="w-[150px] h-[80px] bg-black hover:bg-[#76d5cb] hover:text-black text-white transition duration-500 xl:flex hidden flex-col fixed top-0 right-0 justify-between  p-[10px] cursor-pointer"
        >
